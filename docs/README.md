...
- [Travel approvals](travel-approvals.md) — for Managers. Restricting sign-in to approved countries, the notification and approval flow, and the bootstrap exemption.
